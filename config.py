...
def apply_custom_css():
    ...
    <style>
        ...
        .hud-container { background: rgba(15, 23, 42, 0.6); backdrop-filter: blur(12px); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 16px; padding: 15px; display: flex; justify-content: space-between; margin-bottom: 25px; box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.3); flex-wrap: wrap; gap: 10px; }
        .hud-item { text-align: center; flex: 1; min-width: 60px; border-right: 1px solid rgba(255, 255, 255, 0.1); }
        .hud-item:last-child { border-right: none; }
        .hud-label { font-size: 0.65rem; text-transform: uppercase; letter-spacing: 1px; color: #94a3b8; font-weight: 600; }
        .hud-value { font-family: 'Space Mono', monospace; font-size: 1.0rem; font-weight: 700; color: #f8fafc; }
        ...
        .char-img { width: 120px; height: 120px; border-radius: 50%; margin-bottom: 15px; border: 3px solid #475569; background: #0f172a; }
        .char-role { color: #f8fafc; font-size: 1.25rem; font-weight: 700; }
        .char-desc { color: #94a3b8; font-size: 0.85rem; margin-bottom: 20px; }
    </style>
